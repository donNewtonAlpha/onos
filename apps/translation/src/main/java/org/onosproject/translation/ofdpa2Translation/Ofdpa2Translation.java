package org.onosproject.translation.ofdpa2Translation;

import org.onlab.packet.MacAddress;
import org.onosproject.net.flow.criteria.EthCriterion;
import org.onosproject.translation.ofdpa2Translation.ofdpa2Groups.GroupFinder;
...
public class Ofdpa2Translation {
    ...
    public static FlowRule[] translateToOfdpa(FlowRule originalRule, int flowTypeKey){
        ...
        //TODO: Deal with case in port = ALL
        ...
        switch (flowTypeKey){
            ...
            case 20001 : {
                ...
                if (vlanIdCriterion.vlanId().equals(VlanId.NONE)) {
                    selector.extension(new OfdpaMatchVlanVid(tunnelVlanId), originalRule.deviceId());
                } else {
                    selector.extension(new OfdpaMatchVlanVid(vlanIdCriterion.vlanId()), originalRule.deviceId());
                }
                if(flowTypeKey == 20001){
                    MacAddress mac =((EthCriterion) originalRule.selector().getCriterion(Criterion.Type.ETH_DST)).mac();
