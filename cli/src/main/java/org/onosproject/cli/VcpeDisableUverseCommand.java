 ...
 */
@Command(scope = "onos-app-vcpe", name = "disableuverse",
        description = "remove the flows connecting the client to Uverse")
public class VcpeDisableUverseCommand extends AbstractShellCommand {
    ...
    protected void execute() {
        ...
        try {
            ...
            service.disableUverse(clientId);
        } catch (Exception e) {
